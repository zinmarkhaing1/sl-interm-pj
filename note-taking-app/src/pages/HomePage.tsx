...
export const HomePage = () => {
  ...
  const getPriorityColor = (priority: string) => {
    switch (priority) {
      case "High": return "#e74c3c";     // အနီ
      case "Medium": return "#f39c12";   // အဝါ
      case "Low": return "#2ecc71";      // အစိမ်း
      ...
      <MainLayout>
        <Box sx={{ width: "100%" }}>
          ...
          <Grid container spacing={3} sx={{ mb: 4 }}>
            ...
            <Grid size={{ xs: 12, sm: 4 }}>
              <Card sx={{ borderRadius: 3, boxShadow: "0px 4px 12px rgba(0,0,0,0.05)", borderLeft: "6px solid #e74c3c" ,mb:2}}>
                <CardContent>
              ...
              {filteredNotes.map((note: any, index: number) => (
                <Grid size={{ xs: 12, sm: 6, lg: 4 }} key={note._id ?? index}>
                  <Card 
                    ...
                    onClick={() => navigate(`/note-form`)} // create note form စာမျက်နှာဆီ သွားရန်
                  >
                    <CardContent>
