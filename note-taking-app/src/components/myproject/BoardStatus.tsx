          ...
          return (
            ...
            >
              ...
              >
                ...
                <Chip
                  size="small"
                  label={columnNotes.length}
                  sx={{ bgcolor: column.color }}
                />
              </Box>
                ...
                {(provided, snapshot) => (
                  ...
                  >
                    {columnNotes.length ? (
                            ...
                            {(provided, snapshot) => (
                              ...
                              >
                                ...
                                >
                                  ...
                                  >
                                    <Chip
                                      label={note.assignee || "Unassigned"}
                                      size="small"
                                      sx={{
                                        fontSize: "0.7rem",
                                    ...
                                    />
                                    <Chip
                                      label={note.priority || "Priority: none"}
                                      size="small"
                                      sx={{
                                        fontSize: "0.7rem",
                                        color: "text.secondary",
                      ...
                      <Typography
                        variant="body2"
                        sx={{ color: "#6b6a65", mt: 1, fontStyle: "italic" }}
                      >
