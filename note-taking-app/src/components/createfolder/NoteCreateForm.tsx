...
//     switch (activePage) {
//       case '/note/plain-text': return <PlainTextNotePage description={noteDescription} setText={setNoteDescription} />;
//       case '/note/rich-text': return <RichTextNotePage description={noteDescription} setText={setNoteDescription} />;
//       case '/note/mark-down': return <MarkdownPage description={noteDescription} setText={setNoteDescription}/>;
//       case '/note/task-list': return <TaskListPage description={noteDescription} setText={setNoteDescription} />;
//       case '/note/book-mark': return <BookMarkPage description={noteDescription} setText={setNoteDescription}/>; 
//       case '/note/white-board': return <WhiteboardPage description={noteDescription} setText={setNoteDescription}/>;
//       case '/note/spread-sheet': return <SpreadsheetPage description={noteDescription} setText={setNoteDescription} />;
// ;
//       
//       case '/note/pdf-view': 
//         return pdfUrl ? (
...
export const NoteCreateForm = () => {
  ...
  //     case '/note/white-board': return <WhiteboardPage description={noteDescription} setText={setNoteDescription}/>;
  //     case '/note/spread-sheet': return <SpreadsheetPage description={noteDescription} setText={setNoteDescription} />;
  //     case '/note/group-chat': return <GroupChatPage description={noteDescription} setText={setNoteDescription} />;
...
//   const keyProps = { key: currentNoteId || activePage };

//   switch (activePage) {
//     case '/note/plain-text': 
//       return <PlainTextNotePage {...keyProps} description={noteDescription} setText={setNoteDescription} />;
//     case '/note/rich-text': 
//       return <RichTextNotePage {...keyProps} description={noteDescription} setText={setNoteDescription} />;
//     case '/note/mark-down': 
//       return <MarkdownPage {...keyProps} description={noteDescription} setText={setNoteDescription}/>;
//     case '/note/task-list': 
//       return <TaskListPage {...keyProps} description={noteDescription} setText={setNoteDescription} />;
//     case '/note/book-mark': 
//       return <BookMarkPage {...keyProps} description={noteDescription} setText={setNoteDescription}/>; 
//     case '/note/white-board': 
//       return <WhiteboardPage {...keyProps} description={noteDescription} setText={setNoteDescription}/>;
//     case '/note/spread-sheet': 
//       return <SpreadsheetPage {...keyProps} description={noteDescription} setText={setNoteDescription} />;
//     case '/note/group-chat': 
//       return <GroupChatPage {...keyProps} description={noteDescription} setText={setNoteDescription} />;
